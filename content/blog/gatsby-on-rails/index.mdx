...
![a dog in a bowler cap in a burning room with a cup of tea and the caption this is fine](https://res.cloudinary.com/joelhooks-com/image/upload/v1646023534/images/this-is-fine.jpg)
...
using the proxy approach wasn't as sensible. You can to fun nginx ✨tricks✨ on
...
so we needed to use a different solution. A painful sad solution 😭

![screenshot of a quote from Kyle Matthews saying that configurable output directories will never be part of Gatsby](https://res.cloudinary.com/joelhooks-com/image/upload/v1646023534/images/kyle-says-no.png)
